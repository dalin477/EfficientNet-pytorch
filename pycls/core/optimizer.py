...
from . import rmsprop_tf as rmsproptf
...
def construct_optimizer(model):
    ...
    elif optim.OPTIMIZER == "rmsproptf":
        optimizer = rmsproptf.RMSpropTF(
            param_wds,
            lr=optim.BASE_LR,
            alpha=optim.DECAY,
            eps=0.001,
...
def lr_fun_mutisteps(cur_epoch):
    """Steps schedule (cfg.OPTIM.LR_POLICY = 'mutisteps')."""
...
def lr_fun_steps(cur_epoch):
    ...
    ind = math.floor(cur_epoch/cfg.OPTIM.DECAY_EOPCHS)
    return cfg.OPTIM.LR_MULT ** ind
