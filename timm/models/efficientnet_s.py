...
@register_model
def efficientnet_b0(pretrained=False,channel_multiplier=1.0,depth_multiplier=1.0,**kwargs):
    """ EfficientNet-B0 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    model = _gen_efficientnet(
        'efficientnet_b0', channel_multiplier=channel_multiplier, depth_multiplier=depth_multiplier, pretrained=pretrained, **kwargs)
    return model

@register_model
def efficientnet_b1(pretrained=False, channel_multiplier=1.0, depth_multiplier=1.1, **kwargs):
    """ EfficientNet-B1 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    model = _gen_efficientnet(
        'efficientnet_b1', channel_multiplier=channel_multiplier, depth_multiplier=depth_multiplier, pretrained=pretrained, **kwargs)
    return model


@register_model
def efficientnet_b2(pretrained=False, channel_multiplier=1.1, depth_multiplier=1.2, **kwargs):
    """ EfficientNet-B2 """
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    model = _gen_efficientnet(
        'efficientnet_b2', channel_multiplier=channel_multiplier, depth_multiplier=depth_multiplier, pretrained=pretrained, **kwargs)
    return model
...
@register_model
def efficientnet_b3(pretrained=False, channel_multiplier=1.2, depth_multiplier=1.4,**kwargs):
    """ EfficientNet-B3 """
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    print("-------------------------efficientnet_b3-----------------------")
    print("channel_multiplier:"+str(channel_multiplier))
    print("depth_multiplier:" + str(depth_multiplier))
    model = _gen_efficientnet(
        'efficientnet_b3', channel_multiplier=channel_multiplier, depth_multiplier=depth_multiplier, pretrained=pretrained, **kwargs)
    return model
...
@register_model
def efficientnet_b4(pretrained=False,channel_multiplier=1.4, depth_multiplier=1.8, **kwargs):
    """ EfficientNet-B4 """
    # NOTE for train, drop_rate should be 0.4, drop_path_rate should be 0.2
    model = _gen_efficientnet(
        'efficientnet_b4', channel_multiplier=channel_multiplier, depth_multiplier=depth_multiplier, pretrained=pretrained, **kwargs)
    return model


@register_model
def efficientnet_b5(pretrained=False,channel_multiplier=1.6, depth_multiplier=2.2, **kwargs):
    """ EfficientNet-B5 """
    # NOTE for train, drop_rate should be 0.4, drop_path_rate should be 0.2
    model = _gen_efficientnet(
        'efficientnet_b5', channel_multiplier=channel_multiplier, depth_multiplier=depth_multiplier, pretrained=pretrained, **kwargs)
    return model
